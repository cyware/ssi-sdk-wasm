...
require_wasm_exec();
var wasmFilePath = path.join(__dirname, "main.wasm");
var wasmExports;
var isWasmInitialized = initWasm();
async function initWasm() {
  const wasmFile = typeof window === "undefined" ? require("fs").readFileSync(wasmFilePath) : await fetch(wasmFilePath).then((response) => response.arrayBuffer());
  const go = new Go();
